...
INSERT INTO USERS (user_name, full_name, password, account_non_expired, account_non_locked, credentials_non_expired, enabled) VALUES
    ('Fernanda', 'Fernanda Bagolin', '$2a$10$2MG9wpqjFasvTWZUQqyZR.JWZFmAVvHTC1wU0j911mqniaENGrega', 1, 1, 1, 1);

INSERT INTO USERS (user_name, full_name, password, account_non_expired, account_non_locked, credentials_non_expired, enabled) VALUES
    ('Leonel', 'Leonel Mattos', '$2a$12$fH6tBz0ovRyWHYJws6D3K.p7WQ6zGz/95WddB2xud4H3dJYmjhCN2', 1, 1, 1, 1);
